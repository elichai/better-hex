...
pub unsafe fn encode_ssse3<const UPPER: bool>(src: *const u8, dst: *mut u8, byte_len: usize) {
...
pub unsafe fn encode_avx2<const UPPER: bool>(src: *const u8, dst: *mut u8, byte_len: usize) {
